...
public class ActivateMeter extends javax.swing.JInternalFrame {
    ...
    void populateTBL() {
        ...
        createString = "SELECT AcctNo, AcctName, CONVERT(char(10), TransDate, 101), ClassCode, AcctAddress"
                ...
                + " WHERE c.status=s.status AND c.connType=t.connType AND c.Status=4 and acctname LIKE '" + txtsearch.getText() + "%' "
                + " ORDER BY AcctName";
        ...
        try {
            ...
            while (rs.next()) {
                model.addRow(new Object[]{rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), "Activate"});
            }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Here you can activate consumer meter.");
        ...
        jTBLConn.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "AccountNo", "Name of Account ", "AppDate", "Class", "Address", "Activate"
            }
        ) {
